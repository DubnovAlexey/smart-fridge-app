...
export const TRANSLATIONS = {
    ru: {
        ...
        preview_fake_warn: "⚠️ Базы штрих-кодов могут ошибаться. Проверяйте название.",
        preview_ai_loading: "🤖 ИИ анализирует продукт...", // НОВОЕ
    ...
    he: {
        ...
        preview_fake_warn: "⚠️ מסדי נתונים יכולים לטעות. בדוק את השם.",
        preview_ai_loading: "🤖 AI מנתח את המוצר...", // НОВОЕ
    ...
    en: {
        ...
        preview_fake_warn: "⚠️ Databases can be wrong. Verify the name.",
        preview_ai_loading: "🤖 AI is analyzing the product...", // НОВОЕ
